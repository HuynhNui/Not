...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TextEditor_UpdateScrollOffset_mD3F056830FF3FFC3461ED965EB0B7E306536FC3B (TextEditor_t45128DFCB4C388BF7B8153693C9342D5D2358B27* __this, const RuntimeMethod* method) 
{
	...
	float G_B23_0 = 0.0f;
	TextEditor_t45128DFCB4C388BF7B8153693C9342D5D2358B27* G_B23_1 = NULL;
	float G_B22_0 = 0.0f;
	TextEditor_t45128DFCB4C388BF7B8153693C9342D5D2358B27* G_B22_1 = NULL;
	float G_B24_0 = 0.0f;
	float G_B24_1 = 0.0f;
	TextEditor_t45128DFCB4C388BF7B8153693C9342D5D2358B27* G_B24_2 = NULL;
	{
...
IL_0101:
	{
		bool L_41;
		L_41 = TextEditor_get_showCursor_m2A6C5BACAAC0FEC2985858F08839D34B5A296AFA(__this, NULL);
		if (!L_41)
		{
			goto IL_01c1;
		}
	}
	{
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_44 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___scrollOffset);
		float L_45 = L_44->___x;
		il2cpp_codegen_runtime_class_init_inline(Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D_il2cpp_TypeInfo_var);
		float L_46;
		L_46 = Rect_get_width_m620D67551372073C9C32C4C4624C2A5713F7F9A9_inline((&V_2), NULL);
		if ((!(((float)L_43) > ((float)((float)il2cpp_codegen_subtract(((float)il2cpp_codegen_add(L_45, L_46)), (1.0f)))))))
		{
			goto IL_0144;
		}
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D_il2cpp_TypeInfo_var);
		float L_49;
		L_49 = Rect_get_width_m620D67551372073C9C32C4C4624C2A5713F7F9A9_inline((&V_2), NULL);
		V_0 = ((float)il2cpp_codegen_add(((float)il2cpp_codegen_subtract(L_48, L_49)), (1.0f)));
		goto IL_01c1;
	}
...
IL_0144:
	{
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_52 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___scrollOffset);
	...
	}
	{
		...
		float L_56;
		L_56 = Mathf_Max_mF5379E63D2BBAC76D090748695D833934F8AD051_inline(L_55, (0.0f), NULL);
		V_0 = L_56;
		goto IL_01c1;
	}
...
IL_016a:
	{
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_57 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___previousContentSize);
	...
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D_il2cpp_TypeInfo_var);
		float L_63;
		L_63 = Rect_get_x_mB267B718E0D067F2BAE31BA477647FBF964916EB_inline((&V_2), NULL);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_64 = V_4;
		float L_65 = L_64.___x;
		float L_66;
		L_66 = Rect_get_width_m620D67551372073C9C32C4C4624C2A5713F7F9A9_inline((&V_2), NULL);
		il2cpp_codegen_runtime_class_init_inline(Math_tEB65DE7CA8B083C412C969C92981C030865486CE_il2cpp_TypeInfo_var);
		float L_67;
		L_67 = fabsf(((float)il2cpp_codegen_subtract(((float)il2cpp_codegen_add(L_65, (1.0f))), L_66)));
		if ((!(((float)L_62) < ((float)((float)il2cpp_codegen_add(L_63, L_67))))))
		{
			goto IL_01c1;
		}
	}
	{
		il2cpp_codegen_runtime_class_init_inline(Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D_il2cpp_TypeInfo_var);
		float L_68;
		L_68 = Rect_get_width_m620D67551372073C9C32C4C4624C2A5713F7F9A9_inline((&V_2), NULL);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_69 = V_3;
		float L_70 = L_69.___x;
		float L_71;
		L_71 = Mathf_Max_mF5379E63D2BBAC76D090748695D833934F8AD051_inline(((float)il2cpp_codegen_subtract(L_68, L_70)), (0.0f), NULL);
		V_0 = L_71;
	}
...
IL_01c1:
	{
		...
		float L_74;
		L_74 = bankers_roundf(L_73);
		il2cpp_codegen_runtime_class_init_inline(Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D_il2cpp_TypeInfo_var);
		float L_75;
		L_75 = Rect_get_height_mE1AA6C6C725CCD2D317BD2157396D3CF7D47C9D8_inline((&V_2), NULL);
		float L_76;
		L_76 = bankers_roundf(L_75);
...
IL_01f4:
	{
		bool L_78;
		L_78 = TextEditor_get_showCursor_m2A6C5BACAAC0FEC2985858F08839D34B5A296AFA(__this, NULL);
		if (!L_78)
		{
			goto IL_0293;
		}
	...
	{
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_79 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___lastCursorPos);
		...
		if ((!(((float)L_83) > ((float)(0.0500000007f)))))
		{
			goto IL_0293;
		}
	}
	{
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_84 = V_3;
		float L_85 = L_84.___y;
		GUIStyle_t20BA2F9F3FE9D13AAA607EEEBE5547835A6F6580* L_86 = __this->___style;
		NullCheck(L_86);
		float L_87;
		L_87 = GUIStyle_get_lineHeight_mC814199D1ABA3CE38358BA70347562B0CDFEB96E(L_86, NULL);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_88 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___scrollOffset);
		float L_89 = L_88->___y;
		il2cpp_codegen_runtime_class_init_inline(Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D_il2cpp_TypeInfo_var);
		float L_90;
		L_90 = Rect_get_height_mE1AA6C6C725CCD2D317BD2157396D3CF7D47C9D8_inline((&V_2), NULL);
		if ((!(((float)((float)il2cpp_codegen_add(L_85, L_87))) > ((float)((float)il2cpp_codegen_add(L_89, L_90))))))
		{
			goto IL_0261;
		}
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D_il2cpp_TypeInfo_var);
		float L_93;
		L_93 = Rect_get_height_mE1AA6C6C725CCD2D317BD2157396D3CF7D47C9D8_inline((&V_2), NULL);
		GUIStyle_t20BA2F9F3FE9D13AAA607EEEBE5547835A6F6580* L_94 = __this->___style;
		NullCheck(L_94);
		float L_95;
		L_95 = GUIStyle_get_lineHeight_mC814199D1ABA3CE38358BA70347562B0CDFEB96E(L_94, NULL);
		V_1 = ((float)il2cpp_codegen_add(((float)il2cpp_codegen_subtract(L_92, L_93)), L_95));
		goto IL_0293;
	}
...
IL_0261:
	{
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_100 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___scrollOffset);
		float L_101 = L_100->___y;
		if ((!(((float)L_97) < ((float)((float)il2cpp_codegen_add(L_99, L_101))))))
		{
			goto IL_0293;
		}
	}
	{
		...
		GUIStyle_t20BA2F9F3FE9D13AAA607EEEBE5547835A6F6580* L_104 = __this->___style;
		NullCheck(L_104);
		float L_105;
		L_105 = GUIStyle_get_lineHeight_mC814199D1ABA3CE38358BA70347562B0CDFEB96E(L_104, NULL);
		V_1 = ((float)il2cpp_codegen_subtract(L_103, L_105));
	}

IL_0293:
	{
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_106 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___scrollOffset);
	...
	{
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_109 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___scrollOffset);
...
IL_02c1:
	{
		...
		Vector2__ctor_m9525B79969AFFE3254B303A40997A56DEEB6F548_inline((&L_115), G_B24_1, G_B24_0, NULL);
		NullCheck(G_B24_2);
		G_B24_2->___scrollOffset = L_115;
	}

IL_02cb:
	{
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_116 = V_3;
		__this->___lastCursorPos = L_116;
		return;
	}
}
