    ...
    public sealed class GateSystem : MonoBehaviour
    {
        ...
        public GateLogic SpawnTutorialGateById(string gateId, Vector3 spawnPosition)
        {
            ...
            GateLogic instance = SpawnGateInstance(
                ...
                spawnPosition,
                spawnPosition.x,
                Mathf.Max(minGateWorldWidth, gateHalfWidth * 2f) * Mathf.Max(0.25f, gateSizeMultiplier),
                Mathf.Max(minGateWorldWidth, gateHalfWidth * 2f) * Mathf.Max(0.25f, gateSizeMultiplier) * Mathf.Max(0.5f, gateHeightToWidth),
                0);
