...
namespace _Project.Editor
{
    public static class TutorialSceneSetup
    {
        ...
        public static void SetupTutorialUI()
        {
            ...
            TutorialUpgradeDirector upgradeDirector = gameManager.GetComponent<TutorialUpgradeDirector>();
            if (upgradeDirector == null)
            {
                upgradeDirector = gameManager.gameObject.AddComponent<TutorialUpgradeDirector>();
            }

            AssignManagerReferences(tutorialManager, overlay, gameplayDirector, upgradeDirector);
